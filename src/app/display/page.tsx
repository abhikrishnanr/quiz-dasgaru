        ...
        <div className="grid gap-6 rounded-2xl border border-slate-800 bg-slate-900/70 p-8 xl:grid-cols-4">
          <div className="xl:col-span-1">
            ...
            <div className="mt-4 rounded-xl border border-cyan-500/30 bg-slate-950/70 p-4">
              <h3 className="text-sm font-semibold uppercase tracking-wide text-cyan-200">Voice transcript</h3>
              <ul className="mt-3 space-y-2 text-sm text-slate-200">
                ...
                {hostTranscript.length === 0 && <li className="text-slate-400">Transcript will appear as the host speaks.</li>}
              </ul>
            </div>
          </div>
